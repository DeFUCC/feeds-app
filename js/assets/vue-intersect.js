  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      if (_this2.$slots.default && _this2.$slots.default.length > 1) {
        console.log('[VueIntersect] You may only wrap one element in a <intersect> component.');
      } else if (!_this2.$slots.default || _this2.$slots.default.length < 1) {
        console.log('[VueIntersect] You must have one child inside a <intersect> component.');
        return;
      }
