export default {
  ...
  template: `
      <v-snackbar color="grey lighten-3" v-model="$store.auth" multi-line flat vertical :timeout="0" top>
        ...
        <v-form model="validUser">
          ...
          <v-row>
            ...
            <v-col cols="2">
              <v-btn icon @click="$store.auth=false"><v-icon>mdi-close</v-icon></v-btn>
            </v-col>
          </v-row>
